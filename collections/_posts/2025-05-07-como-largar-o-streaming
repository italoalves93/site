...
description: "Um tutorial para leigos"
...
![Fonte: Appgefahren.de](/assets/images/gen/blog/blog-1.webp)
...
Você vai precisar:
* Baixar um servidor do [Plex](https://plex.tv) para o computador 
* Baixar aplicativos do Plex onde você vai assistir/ouvir os seus arquivos (TV, celular, tablet, etc.) O de vídeo se chama "Plex". O de música, "Plexamp".
